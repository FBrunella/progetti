<?php
    ...
    $query = "SELECT * FROM PersonaleAmministrativo";
...
<head>
    ...
    <title>Personale Amministrativo</title>
    <script type="text/javascript">
        ...
        function checkForm() {
            ...
            var reparto = document.getElementById("nomereparto").value;
            var submitButton = document.getElementById("submit_button");

            // Il pulsante sarà abilitato solo se tutti i campi sono valorizzati
            if (cf && nome && cognome && reparto) {
...
<body>
    <h1>Personale Amministrativo</h1>
    <h2>Aggiungi Personale Amministrativo</h2>
    <form action="aggiungi_personale.php" method="post" oninput="checkForm()">
        ...
        <select name="reparto" id="nomereparto" onchange="checkForm()">
        <?php 
    ...
    <h3>Lista personale amministrativo</h3>
    <table>
        <tr>
        ...
        <?php
            while ($row = pg_fetch_array($result)) {
                ...
                echo "<td><form action='modifica_personale.php' method='POST' style='display:inline-block;'> ";
                echo "<input type='hidden' name='cf' value='". $row['cf'] ."'>";
                echo "<button type='submit'>Modifica</button>";
                echo "</form>";
                echo "<form action='elimina_personale.php' method='POST' style='display:inline-block;'> ";
                echo "<input type='hidden' name='cf' value='". $row['cf'] ."'>";
